...
def main(): 
    ...
    for direccion in urls: 
        # Create a new process for each call to bajar_fichero
        p = multiprocessing.Process(target=bajar_fichero, args=(direccion,))
        p.start()
        processes.append(p)  # Append the process object to the list
